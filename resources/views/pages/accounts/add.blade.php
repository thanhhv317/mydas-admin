    ...
    <div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid">
        <div class="kt-portlet kt-portlet--tabs">
            ...
            <div class="kt-portlet__body">
                ...
                @endif
                <form action="{{ route('accounts.post.create') }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="kt-section kt-section--first">
                                        <div class="kt-section__body">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-9 col-xl-6">
                                                    <input class="form-control" type="text" value="{{ old('phone') ? old('phone') : '' }}"  name="phone">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label class="col-xl-3 col-lg-3 col-form-label">Email</label>
                                                <div class="col-lg-9 col-xl-6">
                                                    <input class="form-control" type="email" value="{{ old('email') ? old('email') : '' }}"  name="email">
                                                </div>
                                            </div>
                                            <div class="form-group row">
