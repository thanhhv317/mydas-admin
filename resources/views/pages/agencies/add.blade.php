        ...
        <div class="kt-container  kt-container--fluid ">
            <div class="kt-subheader__main">
                ...
                <div class="kt-subheader__breadcrumbs">
                    <a href="list-agency.php" class="kt-subheader__breadcrumbs-home"><i class="flaticon2-shelter"></i></a>
                    <span class="kt-subheader__breadcrumbs-separator"></span>
                    <a href="list-agency.php" class="kt-subheader__breadcrumbs-link">
                        Danh sách đại lý </a>
                    <span class="kt-subheader__breadcrumbs-separator"></span>
                                    ...
                                    <div class="kt-section kt-section--first">
                                        <div class="kt-section__body">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-9 col-xl-6">
                                                    <div class="kt-avatar kt-avatar--outline kt-avatar--circle-" id="kt_user_edit_avatar">
                                                        <div class="kt-avatar__holder" style="background-image: url('https://mydas.life/assets/media/logos/LOGO%20MYDAS%20FINAL-01.png');"></div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-9 col-xl-6">
                                                    <input class="form-control" type="text" require name="title">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label class="col-xl-3 col-lg-3 col-form-label">Số lượng thành viên giới hạn</label>
                                                <div class="col-lg-9 col-xl-6">
                                                    <input class="form-control" type="number" name="amount" require>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-9 col-xl-6">
                                                    <a href="list-agency.php" class="btn btn-info">Trở về</a>
